...
When [sending a payment](../../fx/payments/send-funds.md), [creating a local withdrawal](../../moving-funds/payouts/withdraw-funds.md) or [ordering a conversion](../../fx/conversions/) you can provide us a webhook (callback) URI - `callbackUri`. We will call it when a payment or withdrawal status changes.
