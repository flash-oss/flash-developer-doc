...
The API token you generate expires in 24 hours. Do not hardcode this: read the expiry from the token's `exp` claim. You can always use `logout` GraphQL mutation to expire it earlier.
