...
{% hint style="danger" %}
Do not retry same withdrawal if it was rejected by us, or by the beneficiary financial institution.

Only the withdrawals rejected with code `TECHNICAL_ISSUE` or `CANCELLATION_REQUESTED_BY_PARTICIPANT` can be re-submitted as new withdrawals.
{% endhint %}
